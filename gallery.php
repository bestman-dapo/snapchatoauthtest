...
<head>
    ...
    <meta property="snap:sticker" content="https://snapchatoauthtest.herokuapp.com/images/download.png" />
  ...
  <div></div>
    <div class="container-lg">
        <div class="row gy-4 row-cols-1 row-cols-sm-2 row-cols-md-3">
            ...
            <div  class="snapchat-creative-kit-share" data-theme="dark" data-share-url="https://snapchatoauthtest.herokuapp.com/images/download.png"></div>
            </div>
            <div class="col">
